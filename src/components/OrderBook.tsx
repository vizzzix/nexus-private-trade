...
export const OrderBook = () => {
  ...
  const mockOrders = [
    { price: "3,247.89", amount: "***.**", total: "***,***.**", type: "sell" },
    { price: "3,247.67", amount: "***.**", total: "***,***.**", type: "sell" },
    { price: "3,247.45", amount: "***.**", total: "***,***.**", type: "sell" },
    { price: "3,247.23", amount: "***.**", total: "***,***.**", type: "sell" },
    { price: "3,247.01", amount: "***.**", total: "***,***.**", type: "buy" },
    { price: "3,246.89", amount: "***.**", total: "***,***.**", type: "buy" },
    { price: "3,246.67", amount: "***.**", total: "***,***.**", type: "buy" },
    { price: "3,246.45", amount: "***.**", total: "***,***.**", type: "buy" },
  ];
          ...
          <div className="space-y-1">
            ...
            <div className="py-3 border-y border-border my-2">
              <div className="text-center">
                <span className="text-lg font-bold gradient-accent text-gradient">3,247.89</span>
